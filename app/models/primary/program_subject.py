"""
Defines the model for linking programs to enrolled subjects (patients).
"""
...
class ProgramSubject(Base):
    ...
    child_index : int Index used for ordering subjects within the program, ensuring a structured approach
