...
-----------
pathway_id : int
    Foreign key linking to the Pathway model, indicating the associated pathway.
pathway_group_id : int
    Foreign key linking to the PathwayGroups model, representing the group within the pathway.
groupMapOrder_KEY : int
    Key defining the order of groups within the pathway, ensuring clear sequencing.

Relationships:
--------------
pathway : sqlalchemy.orm.relationship
    Relationship with the Pathway model to access pathway details and maintain order integrity.
"""
