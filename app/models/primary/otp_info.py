...
email : str
    Email address associated with the OTP, used for user identification.
is_used : str
    Flag indicating whether the OTP has been used ("Yes" or "No").
otp : str
    The one-time password used for 2FA.
"""
