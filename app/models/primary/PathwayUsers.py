...
class PathwayUsers(Base):
    ...
    Attributes:
    organisation_pathway_id : int  Foreign key linking to the OrganisationPathways model, indicating the pathway associated with the organisation.
    user_id : int  Foreign key linking to the Users model, representing the user assigned to the pathway.
    child_index : int  Index used for ordering users within the pathway, ensuring a structured approach to user assignments.
