...
-----------
pathway_form_id : int
    Unique identifier for the pathway form.
display_name : str
    User-friendly name of the form, displayed in the system.
afobject_id : int
    Identifier linking to the associated AFObject, representing the form's data structure.
group_name : str
    Name of the group to which the form belongs, if applicable.
is_mandatory : str
    Flag indicating whether the form is mandatory ("Yes" or "No").
"""
