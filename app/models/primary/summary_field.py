"""
Represents a field within a summary form, defining individual components of a summary.

This model enables structured creation and management of summary data, ensuring
consistency and facilitating data analysis.
"""
