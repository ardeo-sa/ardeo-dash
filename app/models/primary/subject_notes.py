"""
Stores notes linked to subjects, supporting various note types such as assessments or progress updates.
"""
...
class SubjectNotes(Base):
    ...
    note_type : int Integer code representing the type of note (e.g., assessment, progress, medication).
    You'll likely need a separate lookup table to map these codes to human-readable descriptions.
