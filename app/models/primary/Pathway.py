...
pathway_formsummary_map_order = Table(
    ...
    Column('pathway_id', Integer, ForeignKey('pathway.id'), primary_key=True),
    Column('pathway_form_summary_id', Integer, ForeignKey('pathway_form_summary_map.pathway_form_summary_id'),
           primary_key=True),
...
class Pathway(Base):
    ...
    modified_date = Column('modified_date', DateTime(timezone=True), nullable=False,
    ...
    forms_set = relationship("PathwayForms", secondary=pathway_form_map, backref="pathway", lazy="subquery")
    ...
    form_summary_map_order = relationship('PathwayFormSummaryMap', secondary=pathway_formsummary_map_order,
                                          order_by=pathway_formsummary_map_order.c.child_index, lazy='subquery')
